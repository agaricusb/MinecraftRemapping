...
def main():
    ...
    parser.add_argument("--cbRangeMap", help="CraftBukkit range map generated by srg2source", required=True)
    parser.add_argument("--mcpRangeMap", help="MCP range map generated by srg2source, for local variables", required=True)  # TODO: csv instead?
    parser.add_argument("--mcpConfDir", help="MCP configuration directory", required=True)
    ...
    parser.add_argument("--dumpRenameMap", help="Whether to dump sybmol rename map before renaming", type=bool, choices=(True, False), default=True)
